...
export default inject('user')(observer(
    class extends Component {
        ...
        @action changeRemember = event => this.remember = event.target.checked;
        ...
        submit = event => {
            ...
            this.setPostError('');
            this.props.user.signIn(this.userName, this.password, this.remember)
            ...
            return (
                <div className={css.loginForm}>
                    <form onSubmit={this.submit}>
                        ...
                        <p>
                            Username<br/>
                            <input type="text" name="username" value={this.userName} onChange={this.changeUserName}/>
                        </p>
                        <p>
                            Password<br/>
                        ...
                        <p>
                            <label>
                                <input type="checkbox" checked={this.remember} onChange={this.changeRemember}/> remember
                                me
                            </label>
                        </p>
                        <div className="formErrorBlock">{this.postError}</div>
                        <p>
                            <button type="submit" className="button -default" disabled={!this.canPost}>Sign In</button>
                            {' '}or <CancelLink />
                        </p>
                    </form>
                </div>
