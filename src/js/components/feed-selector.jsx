    ...
    class extends Component {
        ...
        constructor(props) {
            ...
            this.allTargets = this.props.allTargets.sort((a, b) => {
                ...
                const [fa, fb] = [this.isFavored(a.userName), this.isFavored(b.userName)];
                if (fa && !fb) {
                    return -1;
                } else if (!fa && fb) {
                    return 1;
            ...
            return (
                <div className={css.feedSelector}>
                    <div className={css.list}>
                        {this.allTargets.map(t => <Item key={t.userName}
                                                        target={t}
...
class Item extends Component {
    render() {
        const {target: {userName, screenName, avatar, isMyFeed}, isFavored, isSelected} = this.props;
        ...
        return (
            <div className={className} onClick={this.props.onClick}>
                <div className={css.avatar}><img src={avatar}/></div>
